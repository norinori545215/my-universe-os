...
export class CameraControl {
    constructor(canvas, callbacks) {
        ...
        this.isPanning = false; // ★背景をスライドしているかどうかの専用判定
    ...
    initEvents() {
        ...
        this.canvas.addEventListener('touchstart', e => {
            if (e.touches.length === 2) {
                this.isPanning = false; // ズーム中はスライドをキャンセル
